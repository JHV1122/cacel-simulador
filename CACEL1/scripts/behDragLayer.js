function MM_dragLayer(objName,x,hL,hT,hW,hH,toFront,dropBack,cU,cD,cL,cR,targL,targT,tol,dropJS,et,dragJS) { //v4.0 (modern)
  ...
  el.addEventListener("mousedown", function(e) {
    var t = e.target;
    while (t) { if (t.tagName === "A" || t.tagName === "IMG" || t.tagName === "INPUT" || t.tagName === "BUTTON") return; t = t.parentElement; }
    e.preventDefault();
